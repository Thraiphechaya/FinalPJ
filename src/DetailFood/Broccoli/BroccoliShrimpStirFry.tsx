...
const BroccoliShrimpStirFry = () => { 
  const navigation = useNavigation<BroccoliScreenNav>();

  const mainIngredients = [
    { name: 'บรอกโคลี (หั่นชิ้นพอดีคำ)', amount: '1 หัว' },
    { name: 'กุ้งสด (แกะเปลือกผ่าหลัง)', amount: '150 กรัม' },
    { name: 'กระเทียม (สับหยาบ)', amount: '1 ช้อนโต๊ะ' },
    { name: 'น้ำมันหอย', amount: '2 ช้อนโต๊ะ' },
  ...
  const steps = [
    { 
      number: 1, 
      text: 'ล้างบรอกโคลี หั่นเป็นชิ้นพอดีคำ อาจลวกในน้ำเดือดเร็วๆ (30 วินาที) แล้วน็อคน้ำเย็น เพื่อให้สีสวยและกรอบ'
    },
    { 
      number: 2, 
    ...
    { 
      number: 3, 
      text: 'ใส่กุ้งสดลงไป ผัดพอสะดุ้ง ให้กุ้งเริ่มเปลี่ยนสี'
    },
    { 
      number: 4, 
      text: 'ใส่บรอกโคลีที่ลวกเตรียมไว้ลงไป'
    },
    { 
      number: 5, 
    ...
    { 
      number: 6, 
      text: 'เติมน้ำเปล่าหรือน้ำซุปเล็กน้อย ผัดคลุกเคล้าให้เข้ากันอย่างรวดเร็ว (ใช้ไฟแรงได้)'
    },
    { 
      number: 7, 
      text: 'ผัดจนบรอกโคลีสุกกรอบ และกุ้งสุกดี (ระวังอย่าผัดนานไป บรอกโคลีจะนิ่มเละ)'
    },
    { 
      number: 8, 
      text: 'ปิดไฟ โรยพริกไทยป่นเล็กน้อย ตักใส่จาน พร้อมเสิร์ฟ'
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          <Image
            source={{
              uri: 'https://www.calforlife.com/image/food/Stir-Fried-Broccoli-with-Shrimp.jpg'
            }}
            style={styles.image}
          />
          <View style={styles.heroContent}>
            <Text style={styles.title}>บรอกโคลีผัดกุ้ง</Text>
            <View style={[styles.tasteTag, { backgroundColor: '#E8F5E9' }]}>
              ...
              <Text style={[styles.tasteText, { color: '#4CAF50' }]}>อร่อยง่าย ได้ประโยชน์</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.tipContainer}>
            ...
            <Text style={styles.tipText}>การลวกบรอกโคลีก่อนผัด จะช่วยรักษาสีเขียวสดและทำให้ผัดสุกเร็วขึ้น</Text>
          </View>
          <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>ผัดด้วยไฟแรงและใช้เวลาผัดสั้นๆ จะช่วยให้บรอกโคลียังคงความกรอบอร่อย</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
export default BroccoliShrimpStirFry;