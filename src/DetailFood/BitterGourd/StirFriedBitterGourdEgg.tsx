...
const StirFriedBitterGourdEgg = () => {
  const navigation = useNavigation<BitterGourdScreenNav>();

  const mainIngredients = [
    { name: 'มะระจีน (หั่นชิ้นบาง)', amount: '1/2 ลูก' },
    ...
    { name: 'น้ำตาลทราย', amount: '1/2 ช้อนชา (ช่วยลดขม)' },
    { name: 'น้ำมันพืช', amount: '2 ช้อนโต๊ะ' },
    { name: 'เกลือ (สำหรับคลุกมะระ)', amount: 'เล็กน้อย' },
  ...
  const steps = [
    {
      number: 1,
      text: 'หั่นมะระเป็นชิ้นบางๆ คว้านไส้ออก คลุกเกลือทิ้งไว้ 10-15 นาที แล้วล้างออก บีบน้ำให้หมาด'
    },
    {
      number: 2,
      text: 'ตอกไข่ใส่ถ้วย ตีพอแตก ปรุงรสด้วยซีอิ๊วขาวเล็กน้อย'
    },
    {
      number: 3,
    ...
    {
      number: 4,
      text: 'ใส่ไข่ลงไป ยีให้พอสุก ตักขึ้นพักไว้'
    },
    {
      number: 5,
      text: 'ใช้กระทะใบเดิม (อาจเติมน้ำมันเล็กน้อย) ใส่มะระลงไป ผัดด้วยไฟแรงให้มะระสลด'
    },
    {
      number: 6,
      text: 'ปรุงรสด้วย น้ำมันหอย, ซีอิ๊วขาว, น้ำตาลทราย ผัดให้เข้ากัน'
    },
     {
      number: 7,
      text: 'ใส่ไข่ที่พักไว้กลับลงไป ผัดคลุกเคล้าให้เข้ากันเร็วๆ'
    },
     {
      number: 8,
      text: 'ปิดไฟ โรยพริกไทยป่น ตักใส่จาน'
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          <Image
            source={{
              uri: 'https://i.ytimg.com/vi/xUOvKrGBEeM/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCtrxB8VMa9FJdOO0C1btPTyQG0TQ', // Wongnai Image
            }}
            style={styles.image}
          />
          <View style={styles.heroContent}>
            <Text style={styles.title}>มะระผัดไข่</Text>
            <View style={[styles.tasteTag, { backgroundColor: '#FFF9E6' }]}>
               {/* ใช้ไอคอน 'egg-fried' */}
              <MaterialCommunityIcons name="egg-fried" size={16} color="#E65100" />
              <Text style={[styles.tasteText, { color: '#E65100' }]}>ขมน้อย อร่อยกลมกล่อม</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.tipContainer}>
            ...
            <Text style={styles.tipText}>การหั่นมะระบางๆ และคลุกเกลือ ช่วยลดความขมได้ดี</Text>
          </View>
          <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>ผัดมะระด้วยไฟแรงเร็วๆ จะช่วยให้ยังคงความกรอบ ไม่นิ่มเละ</Text>
          </View>
           <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>ใส่น้ำตาลเล็กน้อย จะช่วยตัดรสขมของมะระได้</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
export default StirFriedBitterGourdEgg;