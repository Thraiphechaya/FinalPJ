...
const StirFriedPeasShrimp = () => {
  const navigation = useNavigation<BeanScreenNav>();

  const mainIngredients = [
    { name: 'ถั่วลันเตา', amount: '200 กรัม' },
    { name: 'กุ้งสด (แกะเปลือกผ่าหลัง)', amount: '100 กรัม' },
  ...
  const steps = [
    {
      number: 1,
      text: 'เด็ดขั้วและเส้นข้างของถั่วลันเตา ล้างให้สะอาด พักให้สะเด็ดน้ำ'
    },
    {
      number: 2,
    ...
    {
      number: 4,
      text: 'ใส่ถั่วลันเตาลงไป เร่งไฟแรงขึ้นเล็กน้อย'
    },
    {
      number: 5,
    ...
    {
      number: 6,
      text: 'เติมน้ำเปล่าเล็กน้อย ผัดคลุกเคล้าเร็วๆ ให้เข้ากัน'
    },
     {
      number: 7,
      text: 'ผัดจนถั่วลันเตาสุกกรอบ (ประมาณ 1-2 นาที ระวังอย่าผัดนานไปจะเหนียว)'
    },
     {
      number: 8,
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          <Image
            source={{
              uri: 'https://img.wongnai.com/p/1968x0/2018/12/10/436b226ff373467e856e02645b776289.jpg', // Wongnai Image
            }}
            style={styles.image}
          />
          <View style={styles.heroContent}>
            <Text style={styles.title}>ถั่วลันเตาผัดกุ้ง</Text>
            <View style={[styles.tasteTag, { backgroundColor: '#E8F5E9' }]}>
              ...
              <Text style={[styles.tasteText, { color: '#4CAF50' }]}>กรอบอร่อย ทำง่าย ได้ประโยชน์</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            ...
            <MaterialCommunityIcons name="seed" size={24} color="#388E3C" />
            <View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.tipContainer}>
            ...
            <Text style={styles.tipText}>ใช้ไฟแรงและผัดเร็วๆ จะช่วยให้ถั่วลันเตายังคงความกรอบและสีสวย</Text>
          </View>
          <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>ถ้าชอบรสเผ็ด สามารถใส่พริกชี้ฟ้าหั่นแฉลบลงไปผัดด้วยได้</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
export default StirFriedPeasShrimp;