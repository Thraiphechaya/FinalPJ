...
type EggplantScreenNav = NativeStackNavigationProp<RootStackParamList, 'EggplantScreen'>; 

const FriedEggplantEgg = () => { 
  const navigation = useNavigation<EggplantScreenNav>();

  const mainIngredients = [
    { name: 'มะเขือยาว', amount: '1-2 ลูก' },
    { name: 'ไข่ไก่', amount: '1-2 ฟอง' },
    { name: 'น้ำปลา หรือ ซีอิ๊วขาว', amount: '1 ช้อนชา' },
    { name: 'พริกไทยป่น', amount: 'เล็กน้อย' },
    { name: 'น้ำมันพืช (สำหรับทอด)', amount: 'พอประมาณ' },
  ];

  const steps = [
    { 
      number: 1, 
      text: 'ล้างมะเขือยาว หั่นเป็นแว่นหนาประมาณ 1/2 ซม.'
    },
    { 
      number: 2, 
      text: 'ตอกไข่ใส่ชาม ตีไข่ให้เข้ากัน ปรุงรสด้วยน้ำปลาและพริกไทยเล็กน้อย'
    },
    { 
      number: 3, 
      text: 'ตั้งกระทะ ใส่น้ำมันพืช ใช้ไฟกลาง รอให้น้ำมันร้อน'
    },
    { 
      number: 4, 
      text: 'นำมะเขือยาวที่หั่นไว้ ชุบลงในไข่ที่ตีไว้ให้ทั่ว'
    },
    { 
      number: 5, 
      text: 'นำลงทอดในกระทะ ทอดจนเหลืองสวยทั้งสองด้าน'
    },
     { 
      number: 6, 
      text: 'ตักขึ้นพักบนกระดาษซับน้ำมัน หรือตะแกรง'
    },
     { 
      number: 7, 
      text: 'ทำซ้ำจนหมด'
    ...
    { 
      number: 8, 
      text: 'จัดใส่จาน เสิร์ฟร้อนๆ ทานคู่น้ำพริกกะปิ หรือซอสพริก'
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          <Image
            source={{
              uri: 'https://i.ytimg.com/vi/L5M5JwSVz8w/maxresdefault.jpg',
            }}
            style={styles.image}
          />
          <View style={styles.heroContent}>
            <Text style={styles.title}>มะเขือยาวชุบไข่ทอด</Text>
            <View style={[styles.tasteTag, { backgroundColor: '#FFF9E6' }]}>
              {/* ใช้ไอคอน 'egg-fried' */}
              <MaterialCommunityIcons name="egg-fried" size={16} color="#E65100" />
              <Text style={[styles.tasteText, { color: '#E65100' }]}>นุ่มใน หอมไข่ ทานง่าย</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.tipContainer}>
            ...
            <Text style={styles.tipText}>ใช้ไฟกลางในการทอด จะทำให้มะเขือนุ่มและไข่ไม่ไหม้ก่อน</Text>
          </View>
           <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>ทานคู่กับน้ำพริกกะปิ หรือ น้ำพริกเผา จะอร่อยเข้ากันมาก</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
export default FriedEggplantEgg;