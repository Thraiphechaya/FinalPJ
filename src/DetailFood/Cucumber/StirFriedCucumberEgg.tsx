...
const StirFriedCucumberEgg = () => { 
  ...
  const steps = [
    { 
      number: 1, 
      text: 'ล้างแตงกวา ผ่าครึ่งตามยาว ใช้ช้อนขูดไส้ออก (ถ้ามี) แล้วหั่นเป็นชิ้นตามชอบ'
    },
    { 
      number: 2, 
    ...
    { 
      number: 4, 
      text: 'ใส่แตงกวาลงไป ผัดให้พอสลด (ประมาณ 1-2 นาที)'
    },
    { 
      number: 5, 
      text: 'กันแตงกวาไปข้างกระทะ เทไข่ที่ตีไว้ลงไป ยีไข่ให้สุกพอประมาณ'
    },
    { 
      number: 6, 
      text: 'ผัดไข่กับแตงกวาให้เข้ากัน'
    },
    { 
      number: 7, 
    ...
    { 
      number: 8, 
      text: 'ผัดคลุกเคล้าให้เข้ากันอย่างรวดเร็ว ชิมรส ปรุงเพิ่มได้ตามชอบ'
    },
     { 
      number: 9, 
      text: 'ปิดไฟ โรยพริกไทยป่น ตักใส่จาน เสิร์ฟร้อนๆ'
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          <Image
            source={{
              uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmKiP3a88-fkYH0XLxeUTrY2VlMl1ciLCZR3Ul-U4TRpYElowFnZt9FQNp5FyV3rTOSMo&usqp=CAU'
            }}
            style={styles.image}
          />
          <View style={styles.heroContent}>
            <Text style={styles.title}>แตงกวาผัดไข่</Text>
            <View style={[styles.tasteTag, { backgroundColor: '#FFF9E6' }]}>
              {/* ใช้ไอคอน 'egg-fried' */}
              <MaterialCommunityIcons name="egg-fried" size={16} color="#E65100" />
              <Text style={[styles.tasteText, { color: '#E65100' }]}>เมนูง่ายๆ อร่อยนุ่มนวล</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.tipContainer}>
            ...
            <Text style={styles.tipText}>การขูดไส้แตงกวาออก จะช่วยลดน้ำในแตงกวา ทำให้ผัดแล้วไม่แฉะ</Text>
          </View>
          <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>สามารถใส่หมูสับ กุ้ง หรือเต้าหู้ ลงไปผัดเพิ่มได้</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
export default StirFriedCucumberEgg;