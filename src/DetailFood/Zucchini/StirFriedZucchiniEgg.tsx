...
type ZucchiniScreenNav = NativeStackNavigationProp<RootStackParamList, 'FriedZucchini'>;

const StirFriedZucchiniEgg = () => {
  const navigation = useNavigation<ZucchiniScreenNav>();

  const mainIngredients = [
    { name: 'ซูกินี (หั่นแว่น หรือ หั่นครึ่งวงกลม)', amount: '1-2 ลูก' },
  ...
  const steps = [
    {
      number: 1,
      text: 'ล้างซูกินี หั่นเป็นชิ้นตามชอบ (ถ้าลูกใหญ่ อาจผ่าครึ่งก่อนหั่น)'
    },
    {
      number: 2,
    ...
    {
      number: 4,
      text: 'ใส่ซูกินีลงไป ผัดให้พอสลด (ประมาณ 1-2 นาที ซูกินีสุกเร็วกว่าแตงกวา)'
    },
    {
      number: 5,
      text: 'กันซูกินีไปข้างกระทะ เทไข่ที่ตีไว้ลงไป ยีไข่ให้สุกพอประมาณ'
    },
    {
      number: 6,
      text: 'ผัดไข่กับซูกินีให้เข้ากัน'
    },
    {
      number: 7,
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          <Image
            source={{
              uri: 'https://img.wongnai.com/p/1968x0/2018/11/04/5622f824e9f442cda71d94b6e765e1d7.jpg'
            }}
            style={styles.image}
          />
          <View style={styles.heroContent}>
            <Text style={styles.title}>ซูกินีผัดไข่</Text>
            <View style={[styles.tasteTag, { backgroundColor: '#E8F5E9' }]}>
              {/* ใช้ไอคอน 'egg-fried' */}
              <MaterialCommunityIcons name="egg-fried" size={16} color="#4CAF50" />
              <Text style={[styles.tasteText, { color: '#4CAF50' }]}>นุ่มหวาน อร่อยง่ายๆ</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.tipContainer}>
            ...
            <Text style={styles.tipText}>ซูกินีสุกเร็วกว่าแตงกวา ไม่ต้องผัดนาน ระวังเละ</Text>
          </View>
          <View style={styles.tipContainer}>
            <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#E65100" />
            <Text style={styles.tipText}>สามารถใส่กุ้งสด หรือหมูสับ ลงไปผัดเพิ่มได้</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
export default StirFriedZucchiniEgg;